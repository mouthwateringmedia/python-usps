from usps.api import USPS_CONNECTION_TEST_SECURE, USPS_CONNECTION, USPS_CONNECTION_TEST
...
from usps.api.servicestandards import PriorityMailServiceStandards, PackageServicesServiceStandards, \
    ExpressMailServiceCommitment, get_service_standards
